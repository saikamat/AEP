...
typedef struct {
    ...
    XZhan_suen_uio_map maps[ MAX_UIO_MAPS ];
} XZhan_suen_uio_info;

/***************** Variable Definitions **************************************/
static XZhan_suen_uio_info uio_info;
...
static int uio_info_read_name(XZhan_suen_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XZhan_suen_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XZhan_suen_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XZhan_suen_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XZhan_suen_Initialize(XZhan_suen *InstancePtr, const char* InstanceName) {
	XZhan_suen_uio_info *InfoPtr = &uio_info;
