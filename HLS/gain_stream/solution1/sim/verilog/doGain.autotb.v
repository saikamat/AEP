...
`define LENGTH_inStream_V_data_V 100
`define LENGTH_inStream_V_keep_V 100
`define LENGTH_inStream_V_strb_V 100
`define LENGTH_inStream_V_user_V 100
`define LENGTH_inStream_V_last_V 100
`define LENGTH_inStream_V_id_V 100
`define LENGTH_inStream_V_dest_V 100
`define LENGTH_outStream_V_data_V 100
`define LENGTH_outStream_V_keep_V 100
`define LENGTH_outStream_V_strb_V 100
`define LENGTH_outStream_V_user_V 100
`define LENGTH_outStream_V_last_V 100
`define LENGTH_outStream_V_id_V 100
`define LENGTH_outStream_V_dest_V 100
