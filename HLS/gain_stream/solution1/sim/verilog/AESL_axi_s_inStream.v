...
module AESL_axi_s_inStream (
	...
	fifo #(100, 32) fifo_inStream_TDATA (
		.reset(1'b0),
		.write_clock(clk),
	...
	always @ (*) begin
		...
		inStream_TDATA_read_en <= TRAN_inStream_TREADY;
	end
	...
	fifo #(100, 4) fifo_inStream_TKEEP (
		.reset(1'b0),
		.write_clock(clk),
	...
	always @ (*) begin
		...
		inStream_TKEEP_read_en <= TRAN_inStream_TREADY;
	end
	...
	fifo #(100, 4) fifo_inStream_TSTRB (
		.reset(1'b0),
		.write_clock(clk),
	...
	always @ (*) begin
		...
		inStream_TSTRB_read_en <= TRAN_inStream_TREADY;
	end
	...
	fifo #(100, 2) fifo_inStream_TUSER (
		.reset(1'b0),
		.write_clock(clk),
	...
	always @ (*) begin
		...
		inStream_TUSER_read_en <= TRAN_inStream_TREADY;
	end
	...
	fifo #(100, 1) fifo_inStream_TLAST (
		.reset(1'b0),
		.write_clock(clk),
	...
	always @ (*) begin
		...
		inStream_TLAST_read_en <= TRAN_inStream_TREADY;
	end
	...
	always @ (*) begin
		...
		inStream_TID_read_en <= TRAN_inStream_TREADY;
	end
	...
	fifo #(100, 6) fifo_inStream_TDEST (
		.reset(1'b0),
		.write_clock(clk),
	...
	always @ (*) begin
		...
		inStream_TDEST_read_en <= TRAN_inStream_TREADY;
	end
	...
	assign TRAN_inStream_TVALID = ~(inStream_TDATA_empty || inStream_TKEEP_empty || inStream_TSTRB_empty || inStream_TUSER_empty || inStream_TLAST_empty || inStream_TID_empty || inStream_TDEST_empty) || (inStream_TDATA_valid && inStream_TKEEP_valid && inStream_TSTRB_valid && inStream_TUSER_valid && inStream_TLAST_valid && inStream_TID_valid && inStream_TDEST_valid) || (transaction > `AUTOTB_TRANSACTION_NUM);
