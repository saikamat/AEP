...
$(ObjDir)/test_core_gain.cpp_pre.cpp.tb.o : test_core_gain.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_core_gain.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/core_gain.cpp_pre.cpp.tb.o : core_gain.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling core_gain.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
