...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_r_Addr_A", 32, hls_out, 0, "bram", "mem_address", 1),
	Port_Property("input_r_EN_A", 1, hls_out, 0, "bram", "mem_ce", 1),
	Port_Property("input_r_WEN_A", 4, hls_out, 0, "bram", "mem_we", 1),
	Port_Property("input_r_Din_A", 32, hls_out, 0, "bram", "mem_din", 1),
	Port_Property("input_r_Dout_A", 32, hls_in, 0, "bram", "mem_dout", 1),
	Port_Property("input_r_Clk_A", 1, hls_out, 0, "bram", "mem_clk", 1),
	Port_Property("input_r_Rst_A", 1, hls_out, 0, "bram", "mem_rst", 1),
	Port_Property("result_Addr_A", 32, hls_out, 1, "bram", "mem_address", 1),
	Port_Property("result_EN_A", 1, hls_out, 1, "bram", "mem_ce", 1),
	Port_Property("result_WEN_A", 4, hls_out, 1, "bram", "mem_we", 1),
	Port_Property("result_Din_A", 32, hls_out, 1, "bram", "mem_din", 1),
	Port_Property("result_Dout_A", 32, hls_in, 1, "bram", "mem_dout", 1),
	Port_Property("result_Clk_A", 1, hls_out, 1, "bram", "mem_clk", 1),
	Port_Property("result_Rst_A", 1, hls_out, 1, "bram", "mem_rst", 1),
...
const char* HLS_Design_Meta::dut_name = "zhan_suen";
