...
if {[file isfile zhan_suen.autotvin.dat]} {
	file delete -force zhan_suen.autotvin.dat
}

if {[file isfile zhan_suen.autotvout.dat]} {
	file delete -force zhan_suen.autotvout.dat
}
