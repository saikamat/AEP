...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.zhan_suen.autotvin_input_r.dat"
         "c.zhan_suen.autotvin_result.dat"
         "c.zhan_suen.autotvin_y.dat"
         "c.zhan_suen.autotvout_result.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.zhan_suen.autotvout_result.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
