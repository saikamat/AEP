...
if {[file isfile zhangsueng.autotvin.dat]} {
	file delete -force zhangsueng.autotvin.dat
}

if {[file isfile zhangsueng.autotvout.dat]} {
	file delete -force zhangsueng.autotvout.dat
}
