...
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.zhangsueng.autotvout_ap_return.dat"
...
extern "C" int zhangsueng (
int a,
int b);

#define zhangsueng AESL_ORIG_DUT_zhangsueng
extern "C" int zhangsueng (
int a,
int b);
#undef zhangsueng
...
// [call_c_dut] ---------->
		...
		int AESL_return = AESL_ORIG_DUT_zhangsueng(a, b);
