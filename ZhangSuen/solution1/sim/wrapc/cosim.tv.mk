...
$(ObjDir)/test_zhangsueng.c_pre.c.tb.o : test_zhangsueng.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) test_zhangsueng.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/zhangsueng.c_pre.c.tb.o : zhangsueng.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) zhangsueng.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
