...
`define AUTOTB_DUT      zhangsueng
`define AUTOTB_DUT_INST AESL_inst_zhangsueng
`define AUTOTB_TOP      apatb_zhangsueng_top
`define AUTOTB_LAT_RESULT_FILE "zhangsueng.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "zhangsueng.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_zhangsueng_top
...
`define AUTOTB_TVIN_a  "./c.zhangsueng.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.zhangsueng.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.zhangsueng.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.zhangsueng.autotvin_b.dat"
`define AUTOTB_TVOUT_ap_return  "./c.zhangsueng.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.zhangsueng.autotvout_ap_return.dat"
...
initial begin : generate_AESL_ready_cnt_proc
	...
	initial begin : finish_simulation
		...
		@ (posedge AESL_clock);
		@ (posedge AESL_clock);
    fp1 = $fopen("./rtl.zhangsueng.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.zhangsueng.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.zhangsueng.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.zhangsueng.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.zhangsueng.autotvout_ap_return.dat with impl_rtl.zhangsueng.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
