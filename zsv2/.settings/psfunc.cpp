...
void psfunc(hls::stream<intSdCh> &inStream,hls::stream<intSdCh> &outStream,int iter) {
...
m1= pixel[1].data*pixel[5].data*pixel[7].data;
m2=pixel[5].data*pixel[7].data*pixel[3].data;
x=(A == 1 && (B >= 2 && B <= 6) && !m1 && !m2);


m1=pixel[1].data*pixel[5].data*pixel[3].data;
m2=pixel[1].data*pixel[7].data*pixel[3].data;
y=(A == 1 && (B >= 2 && B <= 6) && !m1 && !m2);
